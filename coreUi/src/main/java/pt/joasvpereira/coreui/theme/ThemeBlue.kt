...
val blue_light_primary = Color(0xFF4E55B1)
val blue_light_onPrimary = Color(0xFFFFFFFF)
val blue_light_primaryContainer = Color(0xFFE0E0FF)
val blue_light_onPrimaryContainer = Color(0xFF00006E)
val blue_light_secondary = Color(0xFF4D57A9)
val blue_light_onSecondary = Color(0xFFFFFFFF)
val blue_light_secondaryContainer = Color(0xFFDFE0FF)
val blue_light_onSecondaryContainer = Color(0xFF000A63)
val blue_light_tertiary = Color(0xFF684FA4)
val blue_light_onTertiary = Color(0xFFFFFFFF)
val blue_light_tertiaryContainer = Color(0xFFE9DDFF)
val blue_light_onTertiaryContainer = Color(0xFF23005C)
...
val blue_light_background = Color(0xFFFFFBFF)
...
val blue_light_surfaceVariant = Color(0xFFE4E1EC)
val blue_light_onSurfaceVariant = Color(0xFF46464F)
val blue_light_outline = Color(0xFF777680)
val blue_light_inverseOnSurface = Color(0xFFF3EFF4)
val blue_light_inverseSurface = Color(0xFF303034)
val blue_light_inversePrimary = Color(0xFFBFC2FF)
val blue_light_shadow = Color(0xFF000000)
val blue_light_surfaceTint = Color(0xFF4E55B1)
val blue_light_outlineVariant = Color(0xFFC7C5D0)
val blue_light_scrim = Color(0xFF000000)

val blue_dark_primary = Color(0xFFBFC2FF)
val blue_dark_onPrimary = Color(0xFF1D2281)
val blue_dark_primaryContainer = Color(0xFF363C98)
val blue_dark_onPrimaryContainer = Color(0xFFE0E0FF)
val blue_dark_secondary = Color(0xFFBCC2FF)
val blue_dark_onSecondary = Color(0xFF1C2678)
val blue_dark_secondaryContainer = Color(0xFF343E90)
val blue_dark_onSecondaryContainer = Color(0xFFDFE0FF)
val blue_dark_tertiary = Color(0xFFD0BCFF)
val blue_dark_onTertiary = Color(0xFF381E72)
val blue_dark_tertiaryContainer = Color(0xFF4F378A)
...
val blue_dark_onBackground = Color(0xFFE5E1E6)
val blue_dark_surface = Color(0xFF1B1B1F)
val blue_dark_onSurface = Color(0xFFE5E1E6)
val blue_dark_surfaceVariant = Color(0xFF46464F)
val blue_dark_onSurfaceVariant = Color(0xFFC7C5D0)
val blue_dark_outline = Color(0xFF918F9A)
val blue_dark_inverseOnSurface = Color(0xFF1B1B1F)
val blue_dark_inverseSurface = Color(0xFFE5E1E6)
val blue_dark_inversePrimary = Color(0xFF4E55B1)
val blue_dark_shadow = Color(0xFF000000)
val blue_dark_surfaceTint = Color(0xFFBFC2FF)
val blue_dark_outlineVariant = Color(0xFF46464F)
